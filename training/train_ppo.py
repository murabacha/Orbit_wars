...
if __name__ == '__main__':
    ...
    parser.add_argument('--bc_checkpoint', type=str, default='checkpoints/bc_pretrained.pt', help='Legacy BC checkpoint path')
    parser.add_argument('--start_step', type=int, default=0, help='The starting timestep for training (useful for resuming)')
